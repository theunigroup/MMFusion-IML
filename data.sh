...
cover_auth="./data/IDT-COVER-auth.txt"
columbia_manip="./data/IDT-Columbia-manip.txt"
columbia_auth="./data/IDT-Columbia-auth.txt"
cocoglide_manip="./data/IDT-CocoGlide-manip.txt"
